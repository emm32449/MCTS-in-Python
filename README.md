...
MCTS-in-Python is a repository that contains simple games with a complex training process. It’s kind of an experiment in “How far can you go with free compute these days?” 
Single Threaded:
